/// https://github.com/cloudtoid/framework/blob/master/src/Cloudtoid.Framework/Contract/Contract.cs
using System;
...
namespace MessagePipe.SharedMemory.InternalClasses
{
    ...
    public static class Contract
    {
        ...
        private static string? GetMessageSafe(string? format, object?[]? args)
        {
            ...
            try
            {
                return string.Format(CultureInfo.InvariantCulture, format!, new object?[] { args! });
            }
